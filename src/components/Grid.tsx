const Grid = () => {
  return (
    <div
      className="pr-24 pl-24  mt-20 bg-[#FDE6D7] pt-[60px] pb-[100px] w-full flex flex-col gap-20 items-center"
      id="concept"
    >
      ...
      <div className="grid-cols-2 grid gap-x-15 max-w-7xl w-full gap-x-28 gap-y-14">
        <div className="bg-white rounded-[20px] p-8 flex flex-col gap-7 grid-container relative shadow-md hover:shadow-xl transition-shadow">
